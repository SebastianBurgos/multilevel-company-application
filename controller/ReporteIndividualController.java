...
public class ReporteIndividualController {
	...
	private void showReporte() {
		...
		case 1:
			...
			break;
		case 2:
			enunciado = "Total de ventas por categoría de producto y método de pago";
		...
		case 4:
			...
			break;
		case 5:
			enunciado = "Total de ventas por estado de envío y método de envío";

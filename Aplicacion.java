...
import multinivel.connection.DatabaseConnection;
...
public class Aplicacion extends Application{
	...
	public void start(Stage primaryStage) throws IOException {
		...
		this.primaryStage.getIcons().add(new Image("file:src/multinivel/view/images/logo.png"));
		mostrarInicio();
	}
	...
	public void abrirVentanaEmergenteNuevaVenta(int idEmpleado) {
		try {
            ...
            // Set the dialog icon.
            dialogStage.getIcons().add(new Image("file:src/multinivel/view/images/logo.png"));
